      ...
      <div className="max-w-lg w-full text-center">
        ...
        <div className="bg-white rounded-2xl shadow-md p-6 mb-8 text-left space-y-5">
          ...
          <div className="flex items-start space-x-4">
            ...
            <div>
              <p className="font-semibold text-gray-800">e-Visa delivered within 24–72 hours</p>
        ...
        <p className="mt-6 text-sm text-gray-500">
          ...
          <a href="mailto:support@indiagovisa.com" className="text-orange-600 hover:underline">
            support@indiagovisa.com
          </a>
        </p>
      </div>
    </div>
